...
class TokenAuth(grpc.AuthMetadataPlugin):
    function __init__(this, token): this.token = token
    function __call__(this, context, callback):
        callback((("authorization", f"Bearer {this.token}"),), null)  # adds metadata per call
